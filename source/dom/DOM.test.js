...
test('should decode HTML as expected', () => {
  const output = decodeHTML('&lt;div class="md"&gt;&lt;p&gt;This just seems like an the onion article&lt;/p&gt;&lt;/div&gt;');
  expect(output).toBe("<div class=\"md\"><p>This just seems like an the onion article</p></div>");
});
