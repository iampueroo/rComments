...
export class UserContext {
	  ...
	  if (this.singleton) {
		...
		getData().then(response => {
			...
			if (modhash) {
				...
				this.singleton._prefersNightmode = dataPrefersNightMode || this.singleton._prefersNightmode;
				console.log(`rComments: User signed in with modhash ${modhash} and nightmode ${dataPrefersNightMode}`);
			} else {
	...
	constructor(modhash: string, usesNewStyles: boolean, prefersNightMode : boolean, prefersNewTabs: boolean) {
