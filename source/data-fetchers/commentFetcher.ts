...
export async function getCommentData(requestOptions: RequestOptions<RequestParams>): Promise<any> {
  ...
  if (!currentParams || requestOptions.data.limit >= currentParams.params.limit) {
